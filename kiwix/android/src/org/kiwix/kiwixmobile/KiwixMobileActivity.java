...
public class KiwixMobileActivity extends AppCompatActivity {
  ...
  private void updateTableOfContents() {
    ...
    //final TextView rowTextView = new TextView(KiwixMobileActivity.this);
    //rowTextView.setText("Feedback Form");
   // mRightArrayAdapter.add(rowTextView);
    //mRightArrayAdapter.notifyDataSetChanged();
    getCurrentWebView().loadUrl("javascript:(" + jsContent + ")()");
    //getCurrentWebView().loadUrl("javascript:(function showAndroidToast() {\n" +
      //      "    alert('function called'); document.getElementsByTagName('body')[0].innerHTML = 'loaded';\n" +
        //    "})()");
  ...
  String fHtml = "<div id=\"feedbackForm\">\n" +
          "    <strong>Feedback Form</strong>\n" +
          "    <form>\n" +
          "        <input id=\"feedbackText\" type=\"text\">\n" +
          "        </br>\n" +
          "        <input type=\"button\" value=\"enter feedback\" onClick=\"showAndroidToast()\" >\n" +
          "        </br>\n" +
          "    </form>\n" +
          "</div>\n" +
          "</br>\n" +
  ...
  private class KiwixWebViewClient extends WebViewClient {
    ...
    public void onPageFinished(WebView view, String url) {
     ...
     /* getCurrentWebView().loadUrl("javascript:(function() {" +
              "var parent = document.getElementsByTagName('head').item(0);" +
              "var script = document.createElement('script');" +
              "script.type = 'text/javascript';" +
              "script.innerHTML = window.atob('" + fHead + "');" +
              "parent.appendChild(script)" +
              "})()");*/
      //getCurrentWebView().loadUrl(
        //      "javascript:(function(){ document.getElementsByTagName('head')[0].innerHTML = document.getElementsByTagName('head')[0].innerHTML + '"+fHead+"' })()"
      //);
      //getCurrentWebView().loadUrl(
        //      "javascript:(function(){ alert(document.getElementsByTagName('head')[0].innerHTML); })()"
      //);
